  ...
  "subclass": [
    ...
    },
    {
      ...
      "entries": [{ "type": "entries", "name": "Grave Domain", "entries": [
        ...
        { "type": "entries", "name": "3rd Level: Channel Divinity: Path to the Grave", "entries": ["As a Magic action, you can expend one use of your Channel Divinity to choose one creature you can see within 30 feet of yourself, cursing it until the end of your next turn. The next time you or an ally hits the cursed target with an attack, the target has Vulnerability to all of that attack's damage, and then the curse ends."] },
