  ...
  "subclass": [
    ...
    },
    {
      ...
      "entries": [{ "type": "entries", "name": "College of Spirits", "entries": [
        "Bards of the College of Spirits seek tales with power from beyond the material plane.",
        { "type": "entries", "name": "3rd Level: Guiding Whispers", "entries": ["You learn the Guidance cantrip. You can cast it with a range of 60 feet."] },
        { "type": "entries", "name": "3rd Level: Spiritual Focus", "entries": ["You can use a candle, crystal ball, skull, spirit board, or tarokka deck as a spellcasting focus for Bard spells. When you cast a Bard spell using this focus, roll a d6; on a 1-5 you deal extra damage or restore extra HP equal to half your Bard level, chosen when you cast the spell."] },
        { "type": "entries", "name": "3rd Level: Tales from Beyond", "entries": ["You reach out to spirits to spin tales from beyond the Material Plane. Expend a Bardic Inspiration die and roll it. The story told is determined by the result, granting effects such as: healing nearby allies (low roll), Enthralling Performance (mid roll), or Destructive Wave (high roll)."] },
        { "type": "entries", "name": "6th Level: Spirit Session", "entries": ["Spirits provide spiritual tales to you and your allies. Spend 1 Bardic Inspiration during a Short Rest in a ritual. You and a number of willing creatures equal to your Charisma modifier (min 1) can add half your Bard level to their next d20 test within 24 hours."] },
        { "type": "entries", "name": "14th Level: Mystical Connection", "entries": ["You can always benefit from Spiritual Focus; the additional effect now applies on a 1-4 on the d6. Your Tales from Beyond now allows you to reroll once and take either result."] }
      ]}]
    },
    {
      "name": "Hexblade",
